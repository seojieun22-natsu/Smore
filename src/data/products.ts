...
export const products: Product[] = [
  ...
  // 카메라/전자
  {
    ...
    brand: '스모어 자체제작',
    notes: [
      '메모리카드(SD카드)는 별도 구매가 필요하며, A/S 문의는 스모어몰 온라인 사이트로 안내해 주세요.',
      '16gb ~ 32gb 메모리카드만 장착 가능하며, 그 이상 용량은 인식되지 않을 수 있어요.',
      '완충 후 연속 사용은 약 3시간 정도 가능하고, 자동 전원 꺼짐 기능이 있어 실제 사용 시간은 6시간 이상으로 안내할 수 있어요.',
      'SD카드 삽입 후 딸깍 소리가 나지 않으면 불량 가능성 있어 교환 처리해 주세요.',
      '충격으로 화면이 멈추면 충전기에 연결한 채 자동 종료될 때까지 기다린 뒤 다시 켜 주세요.',
      '카메라 켜서 디피하면 고객 관심도가 높아지고, 보조배터리 상태도 중간중간 확인해 주세요.',
      '메모리카드는 토이카메라 1개당 1개만 함께 판매해 주세요.',
    ],
